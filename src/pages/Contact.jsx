import { Mail, Phone, MapPin,SendHorizonal, Linkedin, Instagram, Github } from "lucide-react";
          ...
          <div>
            ...
            <div className="mt-10">
              ...
              <div className="flex  gap-5">
                <a href="https://www.linkedin.com/in/anjali-ray-592200341/" className="hover:text-blue-400">
                  <Linkedin />
                </a>
                <a href="https://github.com/AnjaliRayyy" className="hover:text-blue-400">
                  <Github />
                </a>
                <a href="https://www.instagram.com/anjali_rayyy/?hl=en" className="hover:text-blue-400">
                  <Instagram />
                </a>
              </div>
            </div>
